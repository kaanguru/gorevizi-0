...
export default function SettingsScreen() {
  ...
  return (
    <View className="bg-background-light dark:bg-background-dark flex-1  flex-col p-5">
      <View
        id="theme-toggle"
        className=" bg-background-dark p-0"
        style={{ position: 'absolute', top: -40, right: 1, zIndex: 1 }}>
        <Button onPress={(event) => setMode(mode === 'light' ? 'dark' : 'light')}>
          {mode === 'light' ? (
      ...
      <View className="mb-5 flex-1 flex-col items-center justify-items-start gap-9 p-12 ">
        <Button className="mt-5 " onPress={() => router.push('/(tasks)/completed-tasks')}>
        ...
        <Dialog
          ...
          <Dialog.Actions>
            <Button
              ...
              buttonStyle={{ backgroundColor: 'transparent', borderColor: 'black', borderWidth: 1 }}
      ...
      <Dialog
        ...
        />
        <Text>
          This will permanently delete all task completion history and reset statistics. This action
          cannot be undone.
        </Text>
        <Dialog.Actions>
          <Button
      ...
      <View className="bg-background-dark dark:bg-background-light mt-5 flex-row items-center justify-between rounded-lg p-2">
        <View className="flex-row items-center">
          ...
          <Text className="text-typography-white dark:text-typography-black ms-4">
